...
{% content-ref url="tokenomics/getting-set-up/" %}
[getting-set-up](tokenomics/getting-set-up/)
{% endcontent-ref %}

{% content-ref url="tokenomics/getting-set-up/setting-permissions.md" %}
[setting-permissions.md](tokenomics/getting-set-up/setting-permissions.md)
{% endcontent-ref %}

{% content-ref url="tokenomics/getting-set-up/inviting-members.md" %}
[inviting-members.md](tokenomics/getting-set-up/inviting-members.md)
{% endcontent-ref %}
